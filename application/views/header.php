...
<html>
  <head>
    ...
    <!--Changes BY Bina-->
		<link href="<?php echo base_url(); ?>admincssjs/css/style.css" rel="stylesheet" type="text/css" />
    
    <!-- AdminLTE Skins. Choose a skin from the css/skins
         folder instead of downloading all of them to reduce the load. -->
    <link href="<?php echo base_url(); ?>admincssjs/dist/css/skins/_all-skins.min.css" rel="stylesheet" type="text/css" />
    <!-- DATA TABLES -->
